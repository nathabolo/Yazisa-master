package com.sifiso.ylibrary.YLibrary.dto.toolbox;
...
import com.sifiso.ylibrary.YLibrary.dto.util.WebCheck;
import com.sifiso.ylibrary.YLibrary.dto.util.WebCheckResult;
...
public class BaseVolley {
    ...
    public static boolean checkNetworkOnDevice(Context context) {
        ...
        if (r.isNetworkUnavailable()) {
            Toast.makeText(ctx, "Connect to network dumb ass", Toast.LENGTH_LONG).show();
            return false;
        }
        ...
        return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NetworkError) {
                    ...
                    Log.e(LOG,"Con't connect" + "\n" + error.toString());

                } else {
                    Log.e(LOG, "Con't connect" + error.toString());
                }
